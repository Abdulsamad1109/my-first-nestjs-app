...
export class UsersService {
    ...
    private users = [
	    { id: 1, username: "anson", email: "Anso@me.comn", password: "hello123", role: "MEMBER" },
	    ...
	    { id: 5, username: "jason", email: "Jaso@me.comn", password: "hello123", role: "ADMIN" },
	    { id: 6, username: "henry", email: "Henr@me.comy", password: "hello123", role: "ENGINEER" },
	    { id: 7, username: "marilyn", email: "Mari@me.comlyn", password: "hello123", role: "ADMIN" },
    ];
