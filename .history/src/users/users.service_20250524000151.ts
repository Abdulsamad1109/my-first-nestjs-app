...
export class UsersService {
    ...
    create(user:{ username: string, displayName: string, password: string, role: "ADMIN" | "ENGINEER" | "MEMBER" }) {
        const newUser = {
    ...
    update(id: number, updatUser: { username?: string, displayName?: string, password?: string, role: "ADMIN" | "ENGINEER" | "MEMBER"}) {
