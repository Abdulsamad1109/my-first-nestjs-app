...
export class UsersService {
    ...
    private users = [
	    { id: 1, username: "anson", email: "Anso@me.com", password: "hello123", role: "MEMBER" },
	    ...
	    { id: 5, username: "jason", email: "Jaso@me.com", password: "hello123", role: "ADMIN" },
	    { id: 6, username: "henry", email: "Henr@me.com", password: "hello123", role: "ENGINEER" },
	    { id: 7, username: "marilyn", email: "Mari@me.comyn", password: "hello123", role: "ADMIN" },
    ];
