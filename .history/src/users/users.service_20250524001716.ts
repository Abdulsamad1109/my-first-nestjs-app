...
export class UsersService {
    ...
    private users = [
	    { id: 1, username: "anson", email: "Anso@n", password: "hello123", role: "MEMBER" },
	    ...
	    { id: 5, username: "jason", email: "Jaso@n", password: "hello123", role: "ADMIN" },
	    { id: 6, username: "henry", email: "Henr@y", password: "hello123", role: "ENGINEER" },
	    { id: 7, username: "marilyn", email: "Mari@lyn", password: "hello123", role: "ADMIN" },
    ];
